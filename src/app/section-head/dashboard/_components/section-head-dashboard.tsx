...
export function SectionHeadDashboard({ user }: { user: User }) {
  return (
      ...
      <header className="border-b border-gray-200 bg-white">
        <div className="flex items-center justify-between px-6 py-4">
          <div>
            ...
            <p className="text-xs text-gray-500">Section Head Dashboard</p>
          </div>
          <div className="flex items-center gap-4">
            <div className="text-right">
              ...
              <p className="text-xs text-teal-600">Section Head</p>
            </div>
            <button
      ...
      <div className="space-y-6 px-6 py-8">
        <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
          <h2 className="text-2xl font-bold text-gray-900">
            Welcome, {user.name ?? "Section Head"}
          </h2>
          <p className="mt-2 text-gray-500">
            Provincial Engineers Office - Section Head Panel
          </p>
        </div>
