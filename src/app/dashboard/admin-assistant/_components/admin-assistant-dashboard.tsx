...
export function AdminAssistantDashboard({ user }: { user: User }) {
  return (
      ...
      <header className="border-b border-gray-200 bg-white">
        <div className="flex items-center justify-between px-6 py-4">
          <div>
            ...
            <p className="text-xs text-gray-500">Admin Assistant Dashboard</p>
          </div>
          <div className="flex items-center gap-4">
            <div className="text-right">
              ...
              <p className="text-xs text-green-600">Admin Assistant</p>
            </div>
            <button
      ...
      <div className="space-y-6 px-6 py-8">
        <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-gray-500">
            Provincial Engineers Office - Assistant Panel
          </p>
        </div>
